...
EXPECTED_PROFIT_PER_TRADE = (
    0.010  # be realistic. Setting this too high will eliminate potentially good solutions
)
...
class PEDHyperOptLoss(IHyperOptLoss):
    ...
    def hyperopt_loss_function(
        ...
        **kwargs,
        ...
        profit_approx_loss = (
            ((winning_count * ave_profit) - (act_losing_count * stoploss)) / days_period / 100.0
        )
